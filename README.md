...
由於是程式自動產生字重，有些字的方向可能會錯亂：

![字體方向錯亂預覽](https://github.com/max32002/FakePearl/raw/master/preview/direction_wrong.jpg)

請再回報有問題的字，小弟有空就幫忙修正，圖片裡的「脅」已經改好了，並重新打包上傳。或是您也可以自行使用FontForget開啟「Regular」字重的 ttf 字型檔，就可以透過「Expand Stroke」這一個功能調整字型到您喜歡的字重。
